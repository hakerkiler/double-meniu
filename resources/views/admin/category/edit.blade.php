        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                    {!! Form::model($category,['method' => 'PATCH','route' => ['admin.category.update', $category->id], 'class' => 'form-horizontal',  'role' => "form")) !!}
                    @if ($errors->has())
                            ...
                            <div id="{{ $lang->name }}" class="tab-pane fade {{ $lang->code == 'ro' ? 'active in' : '' }}">
                                @if($lang->code == 'ro')
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::select('parent_id', $categories_all, old('parent_id'), array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
